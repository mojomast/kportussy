import type { Claim, RoadmapMilestone } from './types';
...
export const claims: Claim[] = [
  {
    ...
    risk: 'medium',
    tags: ['agent', 'repo-review', 'subagents'],
    createdAt: '2026-06-02T22:10:00Z',
    nextAction: 'Replay review rubric against 5 repos and attach benchmark scores.',
    ...
    verifications: [
      { id: 'ver-manual-1', method: 'manual-review', verifier: 'mojomast/hermes', decision: 'partially_accepted', confidence: 'medium', rationale: 'Useful output exists; benchmark set not yet broad enough.' }
    ],
  ...
  },
  {
    ...
    status: 'submitted',
    risk: 'medium',
    tags: ['rag', 'retrieval', 'source-trust'],
    ...
    evidence: [
      { id: 'ev-rag-design', type: 'design_spec', relation: 'supports', summary: 'Kportussy spec maps trust_state to retrieval weighting.', sourceRef: 'docs/SPEC.md#ragussy', sensitivity: 'public', freshnessDays: 1 }
    ],
    verifications: [],
  ...
  },
  {
    ...
    domain: 'autonomous-build-quality',
    type: 'performance',
    ...
    status: 'under_review',
    risk: 'high',
    tags: ['build-cycle', 'promotion', 'anti-slop'],
    createdAt: '2026-06-02T22:20:00Z',
    ...
    verifications: [
      { id: 'ver-policy-1', method: 'policy-engine-evaluation', verifier: 'kportussy-policy-v0', decision: 'inconclusive', confidence: 'medium', rationale: 'Policy exists in spec; executable evaluator pending.' }
    ],
  ...
  },
  {
    ...
    status: 'draft',
    risk: 'low',
    tags: ['dashboard', 'clawdeck', 'visibility'],
    ...
    evidence: [
      { id: 'ev-dashboard-code', type: 'repository_commit', relation: 'supports', summary: 'Initial React/Vite dashboard implementation.', sourceRef: 'commit:pending', sensitivity: 'public', freshnessDays: 0 }
    ],
    verifications: [],
